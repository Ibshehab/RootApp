    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       android.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               intent.putExtra("photo",R.drawable.ios);
               startActivity(intent);
           }
       });
        ios=findViewById(R.id.ios);
        fullstack=findViewById(R.id.web);
        fullstack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("photo",R.drawable.fs);
                startActivity(intent);
            }
        });
...
intent.putExtra("photo",R.drawable.an);
                startActivity(intent);
            }
        });
    }
